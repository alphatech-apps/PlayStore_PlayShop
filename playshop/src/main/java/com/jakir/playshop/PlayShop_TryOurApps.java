...
import com.jakir.playshop.tryourapps.TryOurAppHelper;

//
// Created by JAKIR HOSSAIN on 4/11/2025.
//
public class PlayShop_TryOurApps {
    public PlayShop_TryOurApps(Context context, String developerLink) {
        new TryOurAppHelper().tryOurOtherAppsLoad(context, developerLink, 2); // openCountWant means how much time app open then try to load
    }
}
